...
final class CorrectViewController: UIViewController {
    ...
    private func counterDidUpdate(_ value: Int) {
        
        totalScoreNumberLabel.text = "\(value)"
    }
    ...
    private func setConstraints() {
        NSLayoutConstraint.activate([
            ...
            congratulationsLabel.topAnchor.constraint(equalTo: greenRectangleView.topAnchor, constant: 10),
            congratulationsLabel.bottomAnchor.constraint(equalTo: greenRectangleView.bottomAnchor, constant: -350),
            ...
            receiveLabel.topAnchor.constraint(equalTo: congratulationsLabel.topAnchor, constant: 50),
            ...
            nextTurnLabel.topAnchor.constraint(equalTo: starImageView.topAnchor, constant: 200),
